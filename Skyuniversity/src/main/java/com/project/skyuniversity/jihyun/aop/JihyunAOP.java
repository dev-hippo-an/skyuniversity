package com.project.skyuniversity.jihyun.aop;
...
public class JihyunAOP {
	   ...
	   */
		...
		@Pointcut("execution(public * com.project.skyuniversity.jihyun..*Controller.requiredLoginhs_*(..))")
		...
		public void loginCheck(JoinPoint joinPoint) { // 로그인 유무를 검사하는 메소드 작성하기
			...
			if( session.getAttribute("loginuser")  == null ) { //로그인을 안했다면
				...
				String loc = request.getContextPath()+"/loginhs.sky";
