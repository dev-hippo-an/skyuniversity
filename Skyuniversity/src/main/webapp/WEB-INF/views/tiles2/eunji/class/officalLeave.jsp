...
<div>
	<table>
		<tr>
			<td>일자</td><td><input type="text" id="datepicker1"/> ~
  <input type="text" id="datepicker2"/></td>
		</tr>
		<tr>
			<td>전일</td><td><input type="checkbox"/></td><td>시간</td><td><input type="time"/> ~ <input type="time"/></td>
		</tr>
		<tr>
			<td>사유</td>
			<td>
