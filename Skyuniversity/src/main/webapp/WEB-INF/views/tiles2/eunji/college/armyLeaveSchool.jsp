...
<div>
	<table>
		<tr>
			<td>
				<label>학번/성명</label>
				<input type="text" value="${paraMap.deptName}"/>/<input type="text" value="${paraMap.name}"/>
			</td>
			<td>
				<label>학과</label>
		...
		<tr>
			...
			<td>
				<label>학년/이수학기</label>
				<input type="text" value="${paraMap.grade}"/>/<input type="text" value="${paraMap.currentSemester}"/>
			</td>
		</tr>
		<tr>
			<td>
				<label>주소</label>
				<input type="text" value="${paraMap.address}"/><input type="text" value="${paraMap.detailaddress}"/><input type="text" value="${paraMap.extraaddress}"/>
			</td>
		</tr>
	</table>
</div>
		...
		<ul>
			<li>
				<label>병종</label>
					...
					<input type="radio" name="armyKind" id="a"/>
					<label for="btype2">해군</label>
					<input type="radio" name="armyKind" id="b"/>
					<label for="btype3">공군</label>
					<input type="radio" name="armyKind" id="c"/>
					<label for="btype4">해병</label>
					<input type="radio" name="armyKind" id="d"/>
					<label for="btype4">의경</label>
					<input type="radio" name="armyKind" id="e"/>
			...
			<li>
				...
				<button><a href="http://soldiercal.lilysoul.pe.kr/">전역일 계산기</a></button>
			</li>
			<li>
				<label>입영통지서</label>
