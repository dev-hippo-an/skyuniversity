...
<div id="stundentInfoContainer">
	...
	<div id="block1">
		<div id="sInfomation" style="display: flex; justify-content: space-between;">
			...
			<span class="detailInfo">
				...
				<label class="miniTitle">성별</label><input class="readInfo" type="text" value="${loginuser.gender}" readonly/><br>
				<label class="miniTitle">학년</label><input class="readInfo" type="text" value="${loginuser.grade}학년" readonly/><br>
			...
			<span class="detailInfo">
				<label class="miniTitle">입학일자</label><input class="readInfo" type="text" value="${loginuser.enterDay}" readonly/><br>
				<label class="miniTitle">한자성명</label><input class="readInfo" type="text" value="${loginuser.chinaName}" readonly/><br>
				...
				<label class="miniTitle">재적학기</label><input class="readInfo" type="text" value="${loginuser.totalSemester}" readonly/><br>
			...
			<span class="detailInfo">
				<label class="miniTitle">졸업일자</label><input class="readInfo" type="text" value="${loginuser.graduateDay}" readonly/><br>
				<label class="miniTitle">영문성명</label><input class="readInfo" type="text" value="${loginuser.engName}" readonly/><br>
				<label class="miniTitle">소속학부(과)</label><input class="readInfo" type="text" value="${loginuser.deptName}" readonly/><br>
				<label class="miniTitle">이수학부(과)</label><input class="readInfo" type="text" value="" readonly/><br>
				<label class="miniTitle">학적상태</label><input class="readInfo" type="text" value="${loginuser.status}" readonly/><br>
			...
			<span class="detailInfo">
				<label class="miniTitle">남은휴학학기수</label><input class="readInfo" type="text" value="${loginuser.absenceCnt}" readonly/><br>
				<label class="miniTitle">소속전공</label><input class="readInfo" type="text" value="${loginuser.deptName}" readonly/><br>
	...
	<div id="block2">
		<div id="changeAdd">
			<div>
				<div>
					<label class="miniTitle2">우편번호</label><input type="text" class="caInput" name="postcode" value="${loginuser.postcode}"/>
				...
				<label class="miniTitle2">주소</label><input type="text" class="caInput" name="address" value="${loginuser.address}"/><br>
				<label class="miniTitle2">상세주소</label><input type="text" class="caInput" name="detailaddress" value="${loginuser.detailAddress}"/><br>
				<label class="miniTitle2">참고주소</label><input type="text" class="caInput" name="detailaddress" value="${loginuser.extraAddress}"/><br>
				<label class="miniTitle2">연락처</label><input type="text" class="caInput" name="mobile" value="${loginuser.mobile}"/><br>
				<label class="miniTitle2">이메일</label><input type="text" class="caInput" name="email" value="${loginuser.email}"/><br>
				<label class="miniTitle2">한자명</label><input type="text" class="caInput" name="chinaname" value="${loginuser.chinaName}"/><br>
				<label class="miniTitle2">영문명</label><input type="text" class="caInput" name="engname" value="${loginuser.engName}"/>
			</div>
		</div>
		<div id="changePhoto">
